    ...
    processThirdPlaceAndFinals() {
      ...
      this.querySvc.getStage('third-place').then(stage => {
          ...
          if (matchDate > now) {
            ...
            if (matchHome.goals > matchAway.goals) self.podium.third = matchHome._team;
            else if (matchHome.goals < matchAway.goals) self.podium.third = matchAway._team;
            else if (matchHome.penalties > matchAway.penalties) self.podium.third = matchHome._team;
            else if (matchHome.penalties < matchAway.penalties) self.podium.third = matchAway._team;
