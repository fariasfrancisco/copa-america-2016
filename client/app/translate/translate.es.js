...
angular.module('copaamericaApp')
  .config(function ($translateProvider) {
    $translateProvider.translations('es', {
      ...
      MAKE_A_BET_P2: 'Ganá puntos acertando ganadores (y conseguí más puntos acertando la cantidad exacta de goles). También apostá por el ganador del Botín de Oro y ganá más puntos!',
      ...
      MATCHES: 'Partidos',
      MATCHES_P1: 'Podés ganar +2 puntos por cada partido acertando el ganador y +3 puntos más si acertás el resultado.',
